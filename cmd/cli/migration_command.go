...
import (
	...
	_ "github.com/lib/pq"
	usermigration "github.com/mansonxasthur/book-collection/internal/infrastructure/persistence/migrations/user"
...
func NewMigrationCommand() *MigrationCommand {
	return &MigrationCommand{
		BaseCommand: BaseCommand{
			SignatureValue:   "migration",
			DescriptionValue: "Run migration operations",
		},
	}
}
